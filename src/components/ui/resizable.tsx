...
import {
  ...
  type PanelProps as ResizablePanelPrimitiveProps,
  type PanelResizeHandleProps as ResizableHandlePrimitiveProps,
...
>((props, ref) => <ResizablePanelPrimitive ref={ref} {...props} />)
